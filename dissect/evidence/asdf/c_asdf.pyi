...
class _c_asdf(__cs__.cstruct):
    ...
    class table_index(__cs__.Structure):
        prev_table: _c_asdf.uint64
        size: _c_asdf.uint64
        indexes: __cs__.Array[_c_asdf.uint64]
        @overload
        def __init__(
            self,
            prev_table: _c_asdf.uint64 | None = ...,
            size: _c_asdf.uint64 | None = ...,
            indexes: __cs__.Array[_c_asdf.uint64] | None = ...,
        ): ...
        @overload
        def __init__(self, fh: bytes | memoryview | bytearray | BinaryIO, /): ...
